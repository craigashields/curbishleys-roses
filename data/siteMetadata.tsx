...
const siteMetadata: SiteMetadata 
   = {
    title: 'Curbishleys Roses',
    author: 'Craig Shields',
    headerTitle: 'Curbishleys Roses',
    description: 'Family owned and run for over 90 years in the heart of cheshire, stocking a great range of plants at pocket friendly prices.',
    language: 'en-gb',
    theme: 'system', // system, dark or light
    siteUrl: '',
    siteRepo: 'https://github.com/craigashields/curbishleys-roses',
